...
function FormPopulationActiveSecteur(props)
{
...
const [message,setMessage] = useState("Population Active Secteur")
  ...
  const submitManifest = (e)=>
  {
    ...
    uploadData.append('fichier', fichier);
      ...
      fetch('https://modelisationfiscaleapi.herokuapp.com/api/populationActiveOffreSecteur/', {
            ...
            .then(
              res => {   
                  props.dataPopulationActiveSecteur(res)                   
              }
            )
            .catch( (error) =>
              {
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/population_active_secteur_info_execution" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormPopulationActiveSecteur;