...
function FormPopulationProvince(props)
{
...
const [message,setMessage] = useState("Population par province")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi.herokuapp.com/api/population/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
...
export default FormPopulationProvince;