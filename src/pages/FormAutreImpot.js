...
const [message,setMessage] = useState("Autres Impôts");
...
const submitManifest = (e)=>
{
   ...
   fetch('https://modelisationfiscaleapi.herokuapp.com/api/autresImpots/', {
            method:'POST',
            body: uploadData 
          })
          .then( res => res.json())
          .then(
            res => {   
                props.dataDonneeAutresImpots(res)
                navigate('/autre_impot_info')
            }
