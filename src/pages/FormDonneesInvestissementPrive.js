...
function FormDonneesInvestissementPrive(props)
{
...
const [message,setMessage] = useState("données de l'investissement privé")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi.herokuapp.com/api/donneeInvestissementPrive/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
          .then(
            res => {   
                props.dataDonneeInvestissementPrive(res)                   
            }
          )
          .catch( (error) =>
            {
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/donnees_investissement_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormDonneesInvestissementPrive;