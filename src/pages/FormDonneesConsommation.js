...
function FormDonneesConsommation(props)
{
...
const [message,setMessage] = useState("données de la consommation")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi.herokuapp.com/api/donneeConsommation/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
          .then(
            res => {   
                props.dataDonneeConsommation(res)                   
            }
          )
          .catch( (error) =>
            {
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/donnees_consommation_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormDonneesConsommation;