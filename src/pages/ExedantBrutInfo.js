...
console.log(props.exedantBrut)
const total_salaires_urbain_agricultures = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaire_urbain_insdustries_extractives = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaires_urbain_industries_manufactures = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaires_urbain_services = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaires_rural_agricultures = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaire_rural_insdustries_extractives = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaires_rural_industries_manufactures = props.exedantBrut.reduce((total,value)=>
        {
        ...
        const total_salaires_rural_services = props.exedantBrut.reduce((total,value)=>
        {
...
<Row className='justify-content-center '>
        ...
        <div>
        <h6 ><u><b><i className='text-primary'>Table Impôts sur Benefice Brut d’Exploitation</i></b></u></h6>
        </div>
        <div>
      ...
      <tr className='text-primary' style={{border:"2px solid white"}}>
           <th>Province</th>
          <th>Nature : Excédent Brut d'Exploitation</th>
          <th colSpan={4}>Données Excédent Brut d'Exploitation/Milieu Urbain</th>
          <th>Total Excédent Brut d'Exploitation/Milieu Urbain</th>
          <th colSpan={4}>Données Excédent Brut d'Exploitation/Milieu Rural</th>
          <th>Total Excédent Brut d'Exploitation/Milieu Rural</th>
          <th colSpan={3}>Excédent Brut d'Exploitation par Secteur</th>
          <th>Total Impôts sur Bénéfice (EBE)/Province</th>
        </tr>
      </thead>
      <tbody>
        ...
        {props.exedantBrut.map((value)=>
        {
          return  <tr style={{border:"2px solid white"}}>
             <td><b>{value.nom_province}</b></td>
             <td><b>Impôts sur Bénéfice (EBE)</b></td>
