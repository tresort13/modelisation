...
function FormDemandeInterieureRural(props)
{
...
const [message,setMessage] = useState("Démande intérieure en milieu rural par province")
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/demande_interieure_rural" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormDemandeInterieureRural;