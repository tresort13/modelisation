...
function FormTauxNataliteMortalite(props)
{
...
const [message,setMessage] = useState("Taux de natalité/mortalité par province et par milieu")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi/api/tauxNataliteMortalite/', {
          ...
          .then(
            res => {   
                props.dataTauxNataliteMortalite(res)
                console.log(res)      
            }
          )
          .catch( (error) =>
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/taux_natalite_mortalite_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormTauxNataliteMortalite;