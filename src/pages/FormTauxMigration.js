...
function FormTauxMigration(props)
{
...
const [message,setMessage] = useState("Taux de migration par province/milieu")
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/taux_migration_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormTauxMigration;