...
function DemandeInterieureInfo(props)
{
...
props.donneeDepenseCouranteInfo.map(value=>
    ...
    console.log(donneeDepensePublique)
    ...
    const total_milieu_urbain_agriculture_publique =  total_milieu_urbain_agriculture_capital + total_milieu_urbain_agriculture_capital2
    const total_milieu_urbain_mines_publique =  total_milieu_urbain_mines_capital + total_milieu_urbain_mines_capital2
    const total_milieu_urbain_industrie_publique =  total_milieu_urbain_industrie_capital + total_milieu_urbain_industrie_capital2
    const total_milieu_urbain_service_publique = total_milieu_urbain_service_capital + total_milieu_urbain_service_capital2

    const total_milieu_rurale_agriculture_publique =  total_milieu_rurale_agriculture_capital + total_milieu_rurale_agriculture_capital2
    const total_milieu_rurale_mines_publique = total_milieu_rurale_mines_capital + total_milieu_rurale_mines_capital2
    const total_milieu_rurale_industrie_publique =  total_milieu_rurale_industrie_capital + total_milieu_rurale_industrie_capital2
    const total_milieu_rurale_service_publique = total_milieu_rurale_service_capital + total_milieu_rurale_service_capital2

   
    const total_secteur_agriculture_publique =  total_secteur_agriculture_capital2 + total_secteur_agriculture_capital
    const total_secteur_mines_publique = total_secteur_mines_capital2 + total_secteur_mines_capital 
    const total_secteur_industrie_publique =  total_secteur_industrie_capital2 + total_secteur_industrie_capital
    const total_secteur_service_publique = total_secteur_service_capital2 + total_secteur_service_capital
...
export default DemandeInterieureInfo;