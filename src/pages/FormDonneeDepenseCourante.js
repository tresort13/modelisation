...
function FormDonneeDepenseCourante(props)
{
...
const [message,setMessage] = useState("données de dépenses Courante")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi.herokuapp.com/api/donneeDepenseCourante/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
          .then(
            res => {   
                props.dataDonneeDepenseCourante(res)                   
            }
          )
          .catch( (error) =>
            {
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/donnees_depense_courante_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormDonneeDepenseCourante;