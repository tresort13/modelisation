...
function DonneesDepenseCouranteInfo(props)
{
...
<Row className='justify-content-center '>
        ...
        <div>
        <h6 ><u><b><i className='text-primary'>Table de données de dépenses Courantes</i></b></u></h6>
        </div>
        <div>
...
export default DonneesDepenseCouranteInfo;