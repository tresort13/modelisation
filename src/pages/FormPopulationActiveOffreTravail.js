...
function FormPopulationActiveOffreTravail(props)
{
...
const [message,setMessage] = useState("population active dans l'offre de travail")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi.herokuapp.com/api/populationActiveOffre/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/population_active_offre_travail" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormPopulationActiveOffreTravail;