...
function DonneesInvestissementPriveInfo(props)
{
    const isDesktop = useMediaQuery({
      ...
      const isMobileOrTablet = useMediaQuery({
        ...
        const total_milieu_urbain_agriculture = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_urbain_mines = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_urbain_industrie = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_urbain_service = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_rurale_agriculture = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_rurale_mines = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_rurale_industrie = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
        ...
        const total_milieu_rurale_service = props.donneeInvestissementPriveInfo.reduce((total,value)=>
        {
...
export default DonneesInvestissementPriveInfo;