...
console.log(props.tauxImportation)
...
expoImpo[0].annee_fiscale_2022 = Number(exportation_annee_fiscale_2022).toFixed(2)
expoImpo[1].annee_fiscale_2022 = Number(importation_annee_fiscale_2022).toFixed(2)
