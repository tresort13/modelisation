...
function FormTailleReelle(props)
{
...
const [message,setMessage] = useState("Taille réelle de la population par province/milieu")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('manifest', manifest);
    ...
    fetch('https://modelisationfiscaleapi/api/manifestUpload/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/taille_reelle_population" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormTailleReelle;