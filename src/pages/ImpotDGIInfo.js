...
const autre_impots_annee_fiscale_2022_average = (Number((Number(autre_impots_annee_fiscale_2022_temp1) + Number(autre_impots_annee_fiscale_2022_temp2) + Number(autre_impots_annee_fiscale_2022_temp3)) / 3)).toString()
...
const autre_impots_annee_fiscale_2022_final = Number(Number(pib_annee_fiscale_2022) *  Number(autre_impots_annee_fiscale_2022_average_final)).toFixed(2)
console.log(autre_impots_annee_fiscale_2022_final)
...
props.dataDonneeRecettesPubliques(dataDGI)
