...
function FormDonneeExportations(props)
{
...
const [message,setMessage] = useState("données des exportations")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi.herokuapp.com/api/donneeExportation/', {
            method:'POST',
            body: uploadData
          })
          .then( res => res.json())
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/donnees_exportations_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormDonneeExportations;