...
function MethodeCalibrageInfo(props)
{
    const isDesktop = useMediaQuery({
      ...
      const isMobileOrTablet = useMediaQuery({
        ...
        const impot_direct = Number(impotRevenuPersonnePhysique.montant) + Number(autreImpotDirect.montant) + Number(impotRevenuPetrolier.montant) + Number(impotRevenuNonPetrolier.montant)
