...
function AutresImpotsInfo(props)
{
...
console.log(props.autresImpots)
        const total_urbain_autres_impots = props.autresImpots.reduce((total,value)=>
        {
        ...
        const total_rural_autres_impots = props.autresImpots.reduce((total,value)=>
        {
...
<Row className='justify-content-center '>
      ...
      <tr className='text-primary' style={{border:"2px solid white"}}>
           <th>Province</th>
          <th>Nature : Autres Impôts</th>
          <th>Données Autres Impôts/Milieu Urbain</th>
          <th>Total Autres Impôts/Milieu Urbain</th>
          <th>Données Autres Impôts/Milieu rural</th>
          <th>Total Autres Impôts/Milieu rural</th>
          <th>Total Autres Impôts/Province</th>
        </tr>
      </thead>
      <tbody>
...
export default AutresImpotsInfo;