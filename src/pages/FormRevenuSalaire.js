...
const [message,setMessage] = useState("Impôts sur Salaires");
...
const submitManifest = (e)=>
{
   ...
   fetch('https://modelisationfiscaleapi.herokuapp.com/api/revenusSalaires/', {
            method:'POST',
            body: uploadData 
          })
          .then( res => res.json())
          .then(
            res => {   
                props.dataDonneeRevenusSalaire(res)
                navigate('/revenu_salaire_info')
            }
