...
function FormDonneeDepenseCapital(props)
{
...
const [message,setMessage] = useState("données de dépenses en capital")
...
const submitManifest = (e)=>
{
  ...
  uploadData.append('fichier', fichier);
    ...
    fetch('https://modelisationfiscaleapi/api/donneeDepenseCapital/', {
          ...
          .then(
            res => {   
                props.dataDonneeDepenseCapital(res)                   
            }
          )
          .catch( (error) =>
            {
...
<Form>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Link to="/donnees_depense_capital_info" style={{color:'white',textDecorationLine:'none'}}>
...
export default FormDonneeDepenseCapital;